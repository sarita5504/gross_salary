...
void main()
{
    ...
    printf("\t\t1. Jaipur Express special :        10:00 a.m         Alwar Junction\n");
    printf("\t\t2. Barmer Express :                03:00 p.m         Ghaziabad Station\n");       
    printf("\t\t3. Ala Hazrat Express :            04:00 p.m         Alwar Station\n");         
    printf("\t\t4. Ashram Express :                06:00 p.m         Marwar Station\n");         
    printf("\t\t5. pooja SF Express :              07:00 a.m         Ajmer Station\n");
         
    scanf("%d", &i);
    do {
        switch (i) {
        case 1: {
            strcpy(train,"Jaipur Express special ");
                   
            strcpy(station, "Alwar junction ");
        ...
        case 2: {
            strcpy(train,"Barmer Express");                  
            strcpy(station,"Ghaziabad Station");
        ...
        case 4: {
            strcpy(train, "Ashram Express");
            strcpy(station, "Marwar Station");
            time1 = 05;
            time2 = 00;
            a1 = 1759;
            a2 = 1200;
        ...
        case 5: {
            strcpy(train, "Pooja SF Express");
            strcpy(station, "Ajmer Station");
            time1 = 07;
            time2 = 00;
            a1 = 2205;
            a2 = 1905;
